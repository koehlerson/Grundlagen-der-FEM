...
solution(md"""
n Gauss-Punkte in $\xi$-Richtung 
	
n Gauss-Punkte in $\eta$-Richtung 
	
Insgesamt	
$\Rightarrow n \cdot n = 9$ Gauss-Punkte
""", blur=false)
...
# ╔═╡ a5ac599e-6617-11eb-127d-1341969950ff
md"""
!!! note "Hinweis"
    $\dfrac{d^n}{d\xi^n}$ steht hier für die $n$-te Ableitung
"""
...
# ╔═╡ 5887b860-6618-11eb-2006-8bf91f59a4a2
2^3 * (3*2*1)/2
...
$w_k=\int_{-1}^1 l_k^p(\xi)\ d\xi$

Dabei ist $l_k$ das k-te Lagrangepolynom (Polynomgrad: $n-1$) mit den Gausspunkten $\xi_k$ als Stützstellen.
"""
